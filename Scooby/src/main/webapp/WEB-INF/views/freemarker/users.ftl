    <script type="text/javascript" src="${rc.contextPath}/js/all/user.js"></script>
    <div class="container">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <div class="input-group">
                    				    <span class="input-group-addon user_id">First Name</span> 
                                        <input type="text" name="first_name" id="first_name" placeholder="First Name" class="form-control login_input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                    				    <span class="input-group-addon user_id">Middle Name</span> 
                                        <input type="text" name="middle_name" id="middle_name" placeholder="Middle Name" class="form-control login_input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon user_id">Last Name</span>
                                        <input type="text" name="last_name" id="last_name" placeholder="Last Name" class="form-control login_input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon user_id">User Name</span>
                                        <input type="text" name="user_name" id="user_name" placeholder="User Name" class="form-control login_input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon user_id">Email</span>
                                        <input type="text" name="email" id="email" placeholder="Email Address" class="form-control login_input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon user_id">Role</span>
                                        <div class="SumoSelect" tabindex="0">
                                            <select name="user_role" id="user_role" class="form-control SlectBox role">
                                                <option selected="selected" value="Please Select">Please Select</option>
                                                <#list userRole as urool>
	        										<option value="${urool.id}-${urool.datavalue}">${urool.datavalue}</option>
	        									</#list>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="employee" style="display:none">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Employee Id</span>
                                             <input type="text" name="empId" id="empId" placeholder="Employee Id" class="form-control login_input">
                                        </div>
                                    </div>
                                </div>
                                <div class="client" style="display:none">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Company Name</span>
                                             <input type="text" name="company_name" id="company_name" placeholder="Name of Company" class="form-control login_input">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Address</span>
                                            <input type="text" name="address" id="address" placeholder="Address" class="form-control login_input">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">City</span>
                                            <input type="text" name="city" id="city" placeholder="Enter City" class="form-control login_input">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Post Code </span>
                                            <input type="text" name="zippcode" id="zippcode" placeholder="Post Code / Zipp code" class="form-control login_input">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Country</span>
                                            <select class="form-control seleectCountry login_input"  name="country" id="country-selector" autofocus="autofocus" autocorrect="off" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Business Category</span>
                                            <input type="text" name="business_category" id="business_category" placeholder="Business Category" class="form-control login_input">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Designation</span>
                                            <input type="text" name="designation" id="designation" placeholder="Designation" class="form-control login_input">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="input-group">
                                            <span class="input-group-addon user_id">Contact Number</span>
                                            <input type="text" name="contact_number" id="contact_number" placeholder="(123) 456-7878" class="form-control login_input">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="password" value="" name="password" id="password" placeholder="Password" class="form-control login_input">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <span class="input-group-addon user_id">Confirm Pasword</span>
                                        <input class="form-control login_input" placeholder="Confirm Password" name="confirm_password" id="confirm_password" type="password">
                                    </div>
                                </div>
                                <span class="error" id="errorMsg"></span>
                                <br></br>
                                <input class="btn btn-lg btn-primary btn-block" type="button" id="login" value="Request Access To Scooby " onclick="insertUser('${rc.contextPath}');"/>
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    <script src="${rc.contextPath}/js/store/jquery-ui.min.js"></script>
